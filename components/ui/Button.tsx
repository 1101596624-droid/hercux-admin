...
export function Button({
  ...
  const variants = {
    primary: 'bg-primary text-white hover:bg-primary-700 focus:ring-primary-600',
    secondary: 'bg-dark-800 text-white hover:bg-dark-700 focus:ring-dark-600',
    outline: 'border border-dark-300 text-dark-900 hover:bg-dark-50 focus:ring-dark-500',
